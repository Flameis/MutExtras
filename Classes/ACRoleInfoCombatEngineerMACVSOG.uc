...
//=============================================================================
class ACRoleInfoCombatEngineerMACVSOG extends RORoleInfoSouthernInfantry;
...
DefaultProperties
{
	...
	Items[RORIGM_Default]={(
					// Primary : DEFAULTS
					PrimaryWeapons=(class'MutExtras.ACWeap_XM177E1_Carbine_MACVSOG', class'MutExtras.ACWeap_M79_GrenadeLauncher'),
					// Secondary Weapons
