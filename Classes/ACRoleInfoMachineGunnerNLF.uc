...
//=============================================================================
class ACRoleInfoMachineGunnerNLF extends RORoleInfoNorthernInfantry
	HideDropDown;
...
DefaultProperties
{
	...
	Items[RORIGM_Default]={(
					// Primary : DEFAULTS
					PrimaryWeapons=(class'ROGame.ROWeap_RPD_LMG', class'ROGame.ROWeap_DP28_LMG', class'ROGame.ROWeap_M1918_BAR'),
					OtherItems=(class'ROGame.ROWeap_Type67_Grenade', class'ROGame.ROWeap_RDG1_SmokeSingle', class'ROGame.ROWeap_PunjiTrap'),		
		)}
