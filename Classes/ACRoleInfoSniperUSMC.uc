...
//=============================================================================
class ACRoleInfoSniperUSMC extends ACRoleInfoSouthernInfantry
	HideDropDown;
...
DefaultProperties
{
	...
	Items[RORIGM_Default]={(
					// Primary : DEFAULTS
					PrimaryWeapons=(class'ROGame.ROWeap_M40Scoped_Rifle', class'ROGame.ROWeap_M1DGarand_SniperRifle'),
