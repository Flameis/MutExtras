...
DefaultProperties
{
	...
	Items[RORIGM_Default]={(
					// Primary : DEFAULTS
					PrimaryWeapons=(class'ROGame.ROWeap_IZH43_Shotgun',class'ROGame.ROWeap_SKS_Rifle',class'ROGame.ROWeap_MN9130_Rifle',class'ROGame.ROWeap_MAS49_Rifle_Grenade'),
					...
					NumOtherItemsForPrimary=(0, 0, 0, 1),
		)}
